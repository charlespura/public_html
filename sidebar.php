...
<div id="sidebar" class="relative bg-gray-800 text-white w-64 transition-all duration-300 h-screen flex flex-col overflow-visible">
  ...
  <button id="sidebar-toggle" 
          class="absolute top-20 -right-5 hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-gray-700 text-white shadow-lg hover:bg-gray-600 transition-all">
